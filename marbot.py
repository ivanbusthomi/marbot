...
from marbot_dockwidget import marbotDockWidget
import os.path
...
class marbot:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&MarBot')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'marbot')
        self.toolbar.setObjectName(u'marbot')

        #print "** INITIALIZING marbot"
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('marbot', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/marbot/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'MarBot'),
            callback=self.run,
